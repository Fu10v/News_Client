...
template <> constexpr inline auto SettingsManager::qt_create_metaobjectdata<qt_meta_tag_ZN15SettingsManagerE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Method 'load'
        QtMocHelpers::MethodData<QVariant(const QString &, const QVariant &)>(6, 2, QMC::AccessPublic, 0x80000000 | 4, {{
            { QMetaType::QString, 3 }, { 0x80000000 | 4, 7 },
        }}),
        // Method 'load'
        QtMocHelpers::MethodData<QVariant(const QString &)>(6, 2, QMC::AccessPublic | QMC::MethodCloned, 0x80000000 | 4, {{
            { QMetaType::QString, 3 },
        }}),
    };
...
void SettingsManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: { QVariant _r = _t->load((*reinterpret_cast<std::add_pointer_t<QString>>(_a[1])),(*reinterpret_cast<std::add_pointer_t<QVariant>>(_a[2])));
            if (_a[0]) *reinterpret_cast<QVariant*>(_a[0]) = std::move(_r); }  break;
        case 2: { QVariant _r = _t->load((*reinterpret_cast<std::add_pointer_t<QString>>(_a[1])));
            if (_a[0]) *reinterpret_cast<QVariant*>(_a[0]) = std::move(_r); }  break;
        default: ;
        }
    }
